...
The controller's H-progress event is also a bisection crossing, not an ordinary
local best-H improvement.  This keeps the active H behavior goal-seeking rather
than minimum-seeking.  No derivative, finite-difference objective, stationarity
requirement, or local-minimum acceptance criterion is introduced.
...
def install_bisection_policy():
    ...
    print("[H-BISECT] H progress=bisection crossing; verifier zero-gate unchanged")
